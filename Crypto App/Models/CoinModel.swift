...
import Foundation
    /*
     ...
     URL: 'https://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&order=market_cap_asc&per_page=250'
     BEARER TOKEN: 'x-cg-demo-api-key: CG-Vbd1N5wPLLmYd3xHHvLHsKXj'
     */
